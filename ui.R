...
shinyUI(fluidPage(theme = shinytheme('cosmo'),
    ...
    wellPanel(
        p("This is a character sheet printer for Walter Kammerer's ",
          a(href="https://play.google.com/store/apps/details?id=com.wgkammerer.testgui.basiccharactersheet.app",
